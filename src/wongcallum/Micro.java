...
/// Defensive combat micro for baby rats. Two rules only, both conservative:
///   1. take a bite if it is favourable — always for a finishing blow, otherwise
///      only when we are not being swarmed (no 1-vs-many trades), and
///   2. otherwise fall back toward home/the king.
/// Cats are never engaged here (4000 hp, unkillable) — fleeing handles them.
/// Offence (throw/carry) is deliberately out of scope: the bot does not initiate.
